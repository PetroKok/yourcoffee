    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse flex-column" id="navbarNavDropdown">
            <ul class="navbar-nav family-bold">
                ...
                <li class="nav-item pl-5 text-white">
                    <a class="nav-link" href="{{route('constructor')}}">Конструктор</a>
                </li>
                <li class="nav-item pl-5 text-white">
                    <a class="nav-link" href="/#franchise">Франшиза</a>
                </li>
                <li class="nav-item pl-5 text-white">
        ...
        <ul class="navbar-nav float-right">
            <a href="{{route('cart.index')}}">
                <li class="nav-item text-black cart-body">
                    <img class="cart-icon" src="{{asset('images/site-images/static/cart.svg', config('app.https'))}}"
                         alt="">
...
<div id="mySidebar" class="sidebar" style="z-index: 2000; text-align: center;">
    ...
    <a href="{{route('about_us')}}">Про нас</a>
